# Available .ID One-Word Domains (15,315)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-15%2C315%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **15,315 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 15,315 domains · **Median ask:** $73.82 · **High-demand under $2,500:** 15
...
| -------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ------------------------------- |
| ccp.id   | available | $14.19    | $20.75        | high           | low    | 3      | namesilo                        |
| eye.id   | resell    | —         | —             | high           | low    | 3      | PT Jetcoms Netindo              |
| ail.id   | premium   | $1,560    | $22.75        | high           | low    | 3      | namecheap                       |
...
| pay.id   | resell    | —         | —             | high           | medium | 3      | PT Biznet Gio Nusantara         |
...
| ate.id   | premium   | $1,455.02 | $20.06        | high           | low    | 3      | namesilo                        |
| aback.id | available | $14.19    | $20.75        | high           | low    | 5      | namesilo                        |
| bike.id  | resell    | —         | —             | high           | low    | 4      | PT Jagat Informasi Solusi (int) |
| baa.id   | premium   | $1,451.03 | $20.06        | high           | low    | 3      | namesilo                        |
| aleut.id | available | $14.19    | $20.75        | high           | low    | 5      | namesilo                        |
| epic.id  | resell    | —         | —             | high           | medium | 4      | PT Media Cloud Indonesia        |
| bbl.id   | premium   | $1,560    | $22.75        | high           | low    | 3      | namecheap                       |
| aleve.id | available | $22.98    | $25.98        | medium         | low    | 5      | namecheap                       |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 15,315 live domains                        |
...
> Unique Domains. *Available .ID One-Word Domains*. Version 2026-09-26. Public GitHub extract for the exact Unique Domains search represented by this repository.
