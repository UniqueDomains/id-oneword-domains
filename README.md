# Available .ID One-Word Domains (24,666)
...
**Public extract:** 1,000 rows · **Live catalog:** 24,666 domains · **Median ask:** $47.42 · **High-demand under $2,500:** 15
...
| --------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ------------------------------- |
| came.id   | available | $17.99    | $20.75        | high           | low    | 4      | namesilo                        |
| hazard.id | resell    | $25.98    | —             | medium         | low    | 6      | PT Jagat Informasi Solusi (int) |
| ala.id    | premium   | $1,455.02 | $20.06        | high           | low    | 3      | namesilo                        |
| grey.id   | available | $14.19    | $20.75        | high           | low    | 4      | namesilo                        |
| add.id    | resell    | —         | —             | high           | low    | 3      | PANDI Registrar                 |
| ana.id    | premium   | $1,455.02 | $20.06        | high           | low    | 3      | namesilo                        |
| acids.id  | available | $17.99    | $20.75        | medium         | low    | 5      | namesilo                        |
| boy.id    | resell    | —         | —             | high           | low    | 3      | PT Jetcoms Netindo              |
| ann.id    | premium   | $1,455.02 | $20.06        | high           | low    | 3      | namesilo                        |
| adios.id  | available | $17.99    | $20.75        | high           | low    | 5      | namesilo                        |
| cap.id    | resell    | —         | —             | high           | low    | 3      | PANDI Registrar                 |
| are.id    | premium   | $1,560    | $22.75        | high           | low    | 3      | namecheap                       |
| annoy.id  | available | $17.99    | $20.75        | high           | low    | 5      | namesilo                        |
| dna.id    | resell    | —         | —             | high           | medium | 3      | PT Jagat Informasi Solusi (int) |
| axe.id    | premium   | $1,455.02 | $20.06        | high           | low    | 3      | namesilo                        |
| bathe.id  | available | $17.99    | $20.75        | high           | low    | 5      | namesilo                        |
| eat.id    | resell    | —         | —             | high           | low    | 3      | PANDI Registrar                 |
| boo.id    | premium   | $1,680    | $24.50        | high           | low    | 3      | namecheap                       |
| beads.id  | available | $17.99    | $20.75        | high           | low    | 5      | namesilo                        |
| gag.id    | resell    | —         | —             | high           | low    | 3      | PANDI Registrar                 |
...
> Unique Domains. *Available .ID One-Word Domains*. Version 2026-09-25. Public GitHub extract for the exact Unique Domains search represented by this repository.
